...
void loop() {
  ...
  if (color.checkForLineaPortero() == true) {
    double degree = anguloIR();
    if (degree < 0) { 
      do {
        motoresRobot.movimientoLinealCorregido(270,velocidades,correccionesImu(),gyro.isRight());
      } while (anguloIR() >= -10 && anguloIR() <= 10 && color.checkForLineaPortero() == true);
    }
    else {
      do {
        motoresRobot.movimientoLinealCorregido(90,velocidades,correccionesImu(),gyro.isRight());
      } while (anguloIR() >= -10 && anguloIR() <= 10 && color.checkForLineaPortero() == true);
    }
  }
    ...
    do {
      motoresRobot.movimientoLinealCorregido(0,velocidades,correccionesIm(),gyro.isRight());
    } while(...)
  }
