...
//    
//    if (interface.call(F("color_detection"), color_thresholdsBlue, sizeof(color_thresholdsBlue), &color_detection_result, sizeof(color_detection_result))) {
